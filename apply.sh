...
original_author="niya-ash"
original_name="flask_boilerplate"
original_urlname="flask-boilerplate"
original_description="Awesome flask_boilerplate created by niya-ash" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/flask_boilerplate "${name}"
...
then
    ...
    echo "then run 'flask_boilerplate' or 'python -m flask_boilerplate'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'flask_boilerplate' or 'python -m flask_boilerplate' or 'poetry run flask_boilerplate'"
fi
