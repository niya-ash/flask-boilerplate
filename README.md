...
- 🎯 Entry points to execute your program using `python -m <flask_boilerplate>` or `$ flask_boilerplate` with basic CLI argument parsing.
...
---
# flask_boilerplate Flask Application

Awesome flask_boilerplate created by niya-ash
...
```bash
git clone https://github.com/niya-ash/flask-boilerplate flask_boilerplate
...
```bash
flask_boilerplate create-db   # run once
flask_boilerplate populate-db  # run once (optional)
flask_boilerplate add-user -u admin -p 1234  # ads a user
flask_boilerplate run
```
